...
- **[2024/01]** Updated the support for ChatGPT-4 (gpt-4-32k: openai chatgpt-4, 32,768 tokens)
...
```shell
# (mandatory) for basic functions
docker pull joshuachou666/autoba:cuda12.2.2-cudnn8-devel-ubuntu22.04-autoba0.1.1
docker run --rm --gpus all -it joshuachou666/autoba:cuda12.2.2-cudnn8-devel-ubuntu22.04-autoba0.1.1 /bin/bash
...
- gpt-4: openai chatgpt-4, 8,192 tokens (default)
- gpt-4-32k: openai chatgpt-4, 32,768 tokens
